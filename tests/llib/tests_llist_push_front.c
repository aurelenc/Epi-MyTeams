...
** Linked List library
** File description:
** tests_llist_push_front
*/

#include <criterion/criterion.h>
#include "llist.h"

Test (list_of_one_elem, llist_push_front)
{
...
Test (list_of_more_than_one_elem, llist_push_front)
{
    llist_t *list = llist_init();
    ...
    cr_assert_str_eq("10", list->first->data);
    cr_assert_str_eq("2", list->first->next->data);
    cr_assert_str_eq("5", list->first->next->next->data);
}
