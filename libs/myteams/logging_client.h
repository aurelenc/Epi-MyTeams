...
** the team, that have the channel, that have the thread, that got the new rep
** ly
*/
...
** When you log out (/logout) you should also
...
** ex: asking the teams you are subscribed to or the available teams in
** a domain
