...
///
/// @brief It searches the database for messages that have the same
/// user id as the one
...
///
/// @brief It searches for messages in the database that have the same
/// discussion id as the one passed as argument
///
/// @param db the database to search in
